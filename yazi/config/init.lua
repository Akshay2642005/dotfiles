...
require("yatline"):setup({
  ...
  style_a = {
    ...
    bg_mode = {
      ...
      select = catppuccin_palette.teal,
      un_set = catppuccin_palette.teal,
    },
  },
  ...
  permissions_w_fg = catppuccin_palette.teal,
  permissions_x_fg = catppuccin_palette.teal,
  ...
  cut = { icon = "", fg = catppuccin_palette.teal },

  total = { icon = "", fg = catppuccin_palette.yellow },
  succ = { icon = "", fg = catppuccin_palette.green },
  fail = { icon = "", fg = catppuccin_palette.teal },
  found = { icon = "", fg = catppuccin_palette.teal },
...
--[[require("yatline-githead"):setup({
  ...
  commit_color = catppuccin_palette.teal,
